  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // `[&>*]:min-w-0` is load-bearing. This is a grid, and a grid item
          // defaults to min-width:auto — it refuses to shrink below its content.
          // One long unbreakable string in a child then widens the whole dialog
          // past max-w-*, and everything inside is clipped at the real edge.
